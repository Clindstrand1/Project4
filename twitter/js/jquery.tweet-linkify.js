...
(function($){
  ...
  window.TweetLinkify = function(tweet, options) {
    ...
    var hyperlinkTarget = (options.hyperlinkTarget != '') ? 'target="_blank"' + options.hyperlinkTarget + '"' : '';
    var mentionTarget = (options.mentionTarget != '') ? 'target="_blank"' + options.mentionTarget + '"' : '';
    var hashtagTarget = (options.hashtagTarget != '') ? 'target="_blank"' + options.hashtagTarget + '"' : '';
